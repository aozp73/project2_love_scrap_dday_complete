...
insert into company_tb(username, password, email, address, detail_address, tel, company_name, company_scale, company_numb, company_field, created_at) values('x', '1234','cos@nate.com', '부산시 빡구 동동', '71길', '01012341234', '(주)미친회사', '대기업', 333322221111,' IT업', now());
