                ...
                <div class="my-border-color-default px-3 py-3" style="width: 50%; ">
                    <form>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="${coPrincipal.companyName}"
                                placeholder="Company Name">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputCompanyAddress" class="form-label">회사주소</label>
                            <input type="text" class="form-control" value="${coPrincipal.address}"
                                placeholder="Company Address">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputCompanyAddress" class="form-label">상세주소</label>
                            <input type="text" class="form-control" value="${coPrincipal.detailAddress}"
                                placeholder="Company Address">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="${coPrincipal.tel}"
                                placeholder="하이픈(-) 없이 입력해주세요"
                                oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword" class="form-label">비밀번호</label>
                            <input type="password" class="form-control" value="${coPrincipal.password}"
                                placeholder="Password">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail" class="form-label">이메일</label>
                            <input type="email" class="form-control" value="${coPrincipal.email}" placeholder="Email">
                        </div>
